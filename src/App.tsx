    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-indigo-800 flex items-center justify-center p-4 font-sans text-white">
      <div className="text-center max-w-xl">
        <div className="mb-6">
          <PlayCircle
            size={80}
            className="mx-auto text-white animate-pulse-slow"
          />
        </div>
        ...
        <p className="mt-4 text-lg md:text-xl font-light opacity-80">
          Upload your Padel performance videos, get detailed analysis, and
          improve your technique with the power of AI.
        </p>
        <button
          onClick={onStart}
      ...
      history: [
        {
          ...
          badPoints: [
            {
              point:
                "Often hitting volleys too high, giving opponents an easy smash.",
              priority: "High",
            },
            {
              point: "Footwork is sometimes static, not moving into the ball.",
              priority: "Medium",
            },
            { point: "Lacks variation in volley shots.", priority: "Low" },
          ],
          improvedPoints: ["Initial positioning has improved since last week."],
          coachNotes:
            "John's volley is a major weapon, but we need to focus on keeping the ball low and varying the angle to become more unpredictable.",
        },
      ],
    },
    {
      ...
      history: [
        {
          ...
          badPoints: [
            {
              point: "Lacking power due to poor body rotation.",
              priority: "High",
            },
            {
              point:
                "The paddle face is too open on contact, leading to slices.",
              priority: "High",
            },
            {
              point: "Recovery to the center is sometimes slow.",
              priority: "Low",
            },
          ],
          improvedPoints: ["Body rotation has seen a slight improvement."],
          coachNotes:
            "Jane's backhand has potential. We'll work on her body rotation in the next few sessions to generate more power and prevent slicing.",
        },
        {
          date: "2023-10-22",
          ...
          goodPoints: ["Strong toss and consistent ball placement."],
          badPoints: [
            {
              point: "Body is not aligned with the net, affecting accuracy.",
              priority: "High",
            },
            { point: "Toss is often too far forward.", priority: "Medium" },
          ],
          improvedPoints: ["Ball toss is more consistent now."],
          coachNotes:
            "Jane has a solid foundation on her serve. Focus on body alignment drills to improve accuracy and make her serve more of a threat.",
        },
      ],
    },
    {
      ...
      history: [
        {
          ...
          badPoints: [
            {
              point:
                "Lacks variation in serve placement, making it predictable.",
              priority: "High",
            },
            {
              point: "Follow-through is sometimes rushed.",
              priority: "Medium",
            },
          ],
          improvedPoints: [
          ...
          coachNotes:
            "Mike's serve is very reliable. The next step is to add more spin and variation to his serves to keep opponents guessing.",
        },
      ],
    },
  ];
    ...
    setTimeout(() => {
      ...
      const mockAiResult = {
        ...
        weaknesses: [
          {
            point:
              "Inconsistent footwork when moving laterally, affecting defensive reach.",
            priority: "High",
          },
          {
            point:
              "Recovery to the center of the court is sometimes slow after a shot.",
            priority: "Medium",
          },
          {
            point:
              "Padel face is slightly too open on defensive backhands, leading to shots with less depth.",
            priority: "Low",
          },
        ],
        drills: [
    ...
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-xs text-gray-400 mt-2">
          (Note: This is an MVP. Just click "Start Analysis" to see a mock
          result and continue.)
        </p>
      </div>
      <div className="mb-6">
  ...
  const TeamDashboardSection = () => (
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">
          Monitor your team's performance at a glance.
        </p>
      </div>
      ...
      <svg className="w-full h-full" viewBox="0 0 100 100">
        ...
        {statValues.map((_, i) => (
          <line
            ...
            x1="50"
            y1="50"
            x2={50 + 40 * Math.cos(i * angle - Math.PI / 2)}
            y2={50 + 40 * Math.sin(i * angle - Math.PI / 2)}
            stroke="#ccc"
          />
        ))}
        <polygon
        ...
        {statLabels.map((label, i) => {
          ...
          return (
            <text
              ...
              fill="#333"
              className="font-bold animate-fill"
            >
              {label}
            </text>
          );
              ...
              <div className="mb-4">
                ...
                >
                  {playerHistory.history.map((analysis, index) => (
                    <option key={index} value={analysis.summary}>
                      {analysis.summary} - {analysis.date}
                    </option>
                  ))}
                </select>
              </div>
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    {Object.entries(selectedAnalysis.stats).map(
                      ([key, value]) => (
                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-2">
                    {["High", "Medium", "Low"].map((priority) => {
                      const points = selectedAnalysis.badPoints.filter(
        ...
        <nav className="flex justify-around bg-white border-t border-gray-200 p-2 z-10">
          <button
            ...
            className={`flex flex-col items-center gap-1 p-2 rounded-lg transition-colors ${
              activeSection === "upload" && !isPostAnalysisReview
                ? "text-blue-600"
